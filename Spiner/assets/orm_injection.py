#!/usr/bin/env python3
# orm_injection.py - ORM Injection Scanner
...
PAYLOAD_FILE = "assets/payloads/ORM Injection.txt"
TIMEOUT = 10

ORM_ERRORS = [
    "SQLAlchemy", "Django", "TypeError", 
    "ValueError", "ObjectNotExecutable",
...
def detect_orm_error(response_text: str) -> bool:
...
def run(target: str, **kwargs) -> Dict[str, Any]:
    ...
    try:
        ...
        if not vulnerable:
            results["result"]["message"] = "ORM инъекции не найдены"
