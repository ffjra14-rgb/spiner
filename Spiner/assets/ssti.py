...
PAYLOAD_FILE = "assets/payloads/SSTI.txt"
TIMEOUT = 10

SSTI_INDICATORS = [
    "49", "777", "config", "subclasses",
...
def detect_ssti(response_text: str) -> bool:
...
def run(target: str, **kwargs) -> Dict[str, Any]:
    ...
    try:
        ...
        if not vulnerable:
            results["result"]["message"] = "SSTI не найдены"
